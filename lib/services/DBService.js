...
class DBService extends Service {
	 ...
	 * @returns {Promise.<null|object>}
	 */
	getBackupResult(clientId, backupId, options) { // eslint-disable-line no-unused-vars
		return Promise.reject(new Error('DBService#getBackupResult not implemented'));
	}
	 ...
	 */
	getClientMonthlyMetrics(clientId, year) { // eslint-disable-line no-unused-vars
		return Promise.reject(new Error('DBService#getClientMonthlyMetrics not implemented'));
	}
	 ...
	 * @returns {Promise.<object|null>}
	 */
	getClientWeeklyMetrics(clientId, year) { // eslint-disable-line no-unused-vars
		return Promise.reject(new Error('DBService#getClientWeeklyMetrics not implemented'));
	}
